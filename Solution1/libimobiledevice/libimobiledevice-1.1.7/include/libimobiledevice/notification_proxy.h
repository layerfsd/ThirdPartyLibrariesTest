...
#define NPSERVICE_API _declspec(dllexport)
 ...
 *   established.
 */
NPSERVICE_API np_error_t np_client_new(idevice_t device, lockdownd_service_descriptor_t service, np_client_t *client);
 ...
 *     code otherwise.
 */
NPSERVICE_API np_error_t np_client_start_service(idevice_t device, np_client_t* client, const char* label);
 ...
 */
NPSERVICE_API np_error_t np_client_free(np_client_t client);
 ...
 */
NPSERVICE_API np_error_t np_post_notification(np_client_t client, const char *notification);
 ...
 */
NPSERVICE_API np_error_t np_observe_notification(np_client_t client, const char *notification);
 ...
 */
NPSERVICE_API np_error_t np_observe_notifications(np_client_t client, const char **notification_spec);
 ...
 */
NPSERVICE_API np_error_t np_set_notify_callback(np_client_t client, np_notify_cb_t notify_cb, void *userdata);
