...
#define FILERELAY_API _declspec(dllexport)
 ...
 */
FILERELAY_API file_relay_error_t file_relay_client_new(idevice_t device, lockdownd_service_descriptor_t service, file_relay_client_t *client);
 ...
 *     code otherwise.
 */
FILERELAY_API file_relay_error_t file_relay_client_start_service(idevice_t device, file_relay_client_t* client, const char* label);
 ...
 */
FILERELAY_API file_relay_error_t file_relay_client_free(file_relay_client_t client);
 ...
 */
FILERELAY_API file_relay_error_t file_relay_request_sources(file_relay_client_t client, const char **sources, idevice_connection_t *connection);
 ...
 *     for the given sources, or FILE_RELAY_E_UNKNOWN_ERROR otherwise.
 */
FILERELAY_API file_relay_error_t file_relay_request_sources_timeout(file_relay_client_t client, const char **sources, idevice_connection_t *connection, unsigned int timeout);
