...
{
	return internal_plist_receive_timeout(client, plist, 60000);
}
 ...
 */
property_list_service_error_t property_list_service_enable_ssl(property_list_service_client_t client, bool bTls)
{
	if (!client || !client->parent)
		return PROPERTY_LIST_SERVICE_E_INVALID_ARG;
	return service_to_property_list_service_error(service_enable_ssl(client->parent, bTls));
}
