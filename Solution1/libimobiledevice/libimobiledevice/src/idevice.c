 ...
 */
idevice_error_t idevice_connection_enable_ssl(idevice_connection_t connection, bool bTls)
{
	...
	/*
	 *  ios10 不支持SSL3.0, 修改为TLS
	*/
	SSL_CTX *ssl_ctx = bTls ? SSL_CTX_new(TLSv1_method()) : SSL_CTX_new(SSLv3_method());
	if (ssl_ctx == NULL) {
