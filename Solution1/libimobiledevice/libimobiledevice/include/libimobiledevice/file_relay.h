...
#define FILE_RELAY_API __declspec( dllexport )
/** @name Error Codes */
/*@{*/
...
FILE_RELAY_API file_relay_error_t file_relay_client_new(idevice_t device, lockdownd_service_descriptor_t service, file_relay_client_t *client);
FILE_RELAY_API file_relay_error_t file_relay_client_free(file_relay_client_t client);

FILE_RELAY_API file_relay_error_t file_relay_request_sources(file_relay_client_t client, const char **sources, idevice_connection_t *connection);
