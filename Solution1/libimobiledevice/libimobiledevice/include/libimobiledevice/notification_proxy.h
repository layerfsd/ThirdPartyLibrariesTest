...
#define NOTIFICATION_PROXY_API __declspec( dllexport )
...
/* Interface */
NOTIFICATION_PROXY_API np_error_t np_client_new(idevice_t device, lockdownd_service_descriptor_t service, np_client_t *client);
NOTIFICATION_PROXY_API np_error_t np_client_free(np_client_t client);
NOTIFICATION_PROXY_API np_error_t np_post_notification(np_client_t client, const char *notification);
NOTIFICATION_PROXY_API np_error_t np_observe_notification(np_client_t client, const char *notification);
NOTIFICATION_PROXY_API np_error_t np_observe_notifications(np_client_t client, const char **notification_spec);
NOTIFICATION_PROXY_API np_error_t np_set_notify_callback(np_client_t client, np_notify_cb_t notify_cb, void *userdata);
