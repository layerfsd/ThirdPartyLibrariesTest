...
#define SCREENSHOTR_API _declspec(dllexport)
 ...
 */
SCREENSHOTR_API screenshotr_error_t screenshotr_client_new(idevice_t device, lockdownd_service_descriptor_t service, screenshotr_client_t * client);
 ...
 *     code otherwise.
 */
SCREENSHOTR_API screenshotr_error_t screenshotr_client_start_service(idevice_t device, screenshotr_client_t* client, const char* label);
 ...
 *     if client is NULL.
 */
SCREENSHOTR_API screenshotr_error_t screenshotr_client_free(screenshotr_client_t client);
 ...
 *     error occured.
 */
SCREENSHOTR_API screenshotr_error_t screenshotr_take_screenshot(screenshotr_client_t client, char **imgdata, uint64_t *imgsize);
