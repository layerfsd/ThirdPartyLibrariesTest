...
#define MOBILEBACKUP_API _declspec(dllexport)
 ...
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_client_new(idevice_t device, lockdownd_service_descriptor_t service, mobilebackup_client_t * client);
 ...
 *     code otherwise.
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_client_start_service(idevice_t device, mobilebackup_client_t* client, const char* label);
 ...
 *     if client is NULL.
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_client_free(mobilebackup_client_t client);
 ...
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_receive(mobilebackup_client_t client, plist_t *plist);
 ...
 * @return an error code
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_send(mobilebackup_client_t client, plist_t plist);
 ...
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_request_backup(mobilebackup_client_t client, plist_t backup_manifest, const char *base_path, const char *proto_version);
 ...
 *    occurs.
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_send_backup_file_received(mobilebackup_client_t client);
 ...
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_request_restore(mobilebackup_client_t client, plist_t backup_manifest, mobilebackup_flags_t flags, const char *proto_version);
 ...
 *    occurs.
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_receive_restore_file_received(mobilebackup_client_t client, plist_t *result);
 ...
 *    occurs.
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_receive_restore_application_received(mobilebackup_client_t client, plist_t *result);
 ...
 *    error occurs.
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_send_restore_complete(mobilebackup_client_t client);
 ...
 */
MOBILEBACKUP_API mobilebackup_error_t mobilebackup_send_error(mobilebackup_client_t client, const char *reason);
