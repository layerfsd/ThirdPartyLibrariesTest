...
#define MOBILESYNC_API _declspec(dllexport)
 ...
 * the device is newer.
 */
MOBILESYNC_API mobilesync_error_t mobilesync_client_new(idevice_t device, lockdownd_service_descriptor_t service, mobilesync_client_t * client);
 ...
 *     code otherwise.
 */
MOBILESYNC_API mobilesync_error_t mobilesync_client_start_service(idevice_t device, mobilesync_client_t* client, const char* label);
 ...
 */
MOBILESYNC_API mobilesync_error_t mobilesync_client_free(mobilesync_client_t client);
 ...
 */
MOBILESYNC_API mobilesync_error_t mobilesync_receive(mobilesync_client_t client, plist_t *plist);
 ...
 * @return an error code
 */
MOBILESYNC_API mobilesync_error_t mobilesync_send(mobilesync_client_t client, plist_t plist);
 ...
 * sync request
 */
MOBILESYNC_API mobilesync_error_t mobilesync_start(mobilesync_client_t client, const char *data_class, mobilesync_anchors_t anchors, uint64_t computer_data_class_version, mobilesync_sync_type_t *sync_type, uint64_t *device_data_class_version, char** error_description);
 ...
 * @retval MOBILESYNC_E_INVALID_ARG if one of the parameters is invalid
 */
MOBILESYNC_API mobilesync_error_t mobilesync_cancel(mobilesync_client_t client, const char* reason);
 ...
 * form
 */
MOBILESYNC_API mobilesync_error_t mobilesync_finish(mobilesync_client_t client);
 ...
 * @retval MOBILESYNC_E_INVALID_ARG if one of the parameters is invalid
 */
MOBILESYNC_API mobilesync_error_t mobilesync_get_all_records_from_device(mobilesync_client_t client);
 ...
 * @retval MOBILESYNC_E_INVALID_ARG if one of the parameters is invalid
 */
MOBILESYNC_API mobilesync_error_t mobilesync_get_changes_from_device(mobilesync_client_t client);
 ...
 * @retval MOBILESYNC_E_PLIST_ERROR if the received plist is not of valid form
 */
MOBILESYNC_API mobilesync_error_t mobilesync_clear_all_records_on_device(mobilesync_client_t client);
 ...
 * session
 */
MOBILESYNC_API mobilesync_error_t mobilesync_receive_changes(mobilesync_client_t client, plist_t *entities, uint8_t *is_last_record, plist_t *actions);
 ...
 * @retval MOBILESYNC_E_INVALID_ARG if one of the parameters is invalid
 */
MOBILESYNC_API mobilesync_error_t mobilesync_acknowledge_changes_from_device(mobilesync_client_t client);
 ...
 */
MOBILESYNC_API mobilesync_error_t mobilesync_ready_to_send_changes_from_computer(mobilesync_client_t client);
 ...
 * not permit this call
 */
MOBILESYNC_API mobilesync_error_t mobilesync_send_changes(mobilesync_client_t client, plist_t entities, uint8_t is_last_record, plist_t actions);
 ...
 * session
 */
MOBILESYNC_API mobilesync_error_t mobilesync_remap_identifiers(mobilesync_client_t client, plist_t *mapping);
 ...
 */
MOBILESYNC_API mobilesync_anchors_t mobilesync_anchors_new(const char *device_anchor, const char *computer_anchor);
 ...
 */
MOBILESYNC_API void mobilesync_anchors_free(mobilesync_anchors_t anchors);
 ...
 */
MOBILESYNC_API plist_t mobilesync_actions_new();
 ...
 */
MOBILESYNC_API void mobilesync_actions_add(plist_t actions, ...);
 ...
 */
MOBILESYNC_API void mobilesync_actions_free(plist_t actions);
