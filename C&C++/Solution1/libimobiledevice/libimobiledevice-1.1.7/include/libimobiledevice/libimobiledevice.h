...
#define IDEVICE_API _declspec(dllexport)
 ...
 */
IDEVICE_API idevice_error_t idevice_event_subscribe(idevice_event_cb_t callback, void *user_data);
 ...
 * @return IDEVICE_E_SUCCESS on success or an error value when an error occured.
 */
IDEVICE_API idevice_error_t idevice_event_unsubscribe();
 ...
 * @return IDEVICE_E_SUCCESS on success or an error value when an error occured.
 */
IDEVICE_API idevice_error_t idevice_get_device_list(char ***devices, int *count);
 ...
 */
IDEVICE_API idevice_error_t idevice_device_list_free(char **devices);
 ...
 */
IDEVICE_API idevice_error_t idevice_new(idevice_t *device, const char *udid);
 ...
 */
IDEVICE_API idevice_error_t idevice_free(idevice_t device);
 ...
 * @return IDEVICE_E_SUCCESS if ok, otherwise an error code.
 */
IDEVICE_API idevice_error_t idevice_connect(idevice_t device, uint16_t port, idevice_connection_t *connection);
 ...
 * @return IDEVICE_E_SUCCESS if ok, otherwise an error code.
 */
IDEVICE_API idevice_error_t idevice_disconnect(idevice_connection_t connection);
 ...
 * @return IDEVICE_E_SUCCESS if ok, otherwise an error code.
 */
IDEVICE_API idevice_error_t idevice_connection_send(idevice_connection_t connection, const char *data, uint32_t len, uint32_t *sent_bytes);
 ...
 * @return IDEVICE_E_SUCCESS if ok, otherwise an error code.
 */
IDEVICE_API idevice_error_t idevice_connection_receive_timeout(idevice_connection_t connection, char *data, uint32_t len, uint32_t *recv_bytes, unsigned int timeout);
 ...
 * @return IDEVICE_E_SUCCESS if ok, otherwise an error code.
 */
IDEVICE_API idevice_error_t idevice_connection_receive(idevice_connection_t connection, char *data, uint32_t len, uint32_t *recv_bytes);
 ...
 */
IDEVICE_API idevice_error_t idevice_connection_enable_ssl(idevice_connection_t connection);
 ...
 */
IDEVICE_API idevice_error_t idevice_connection_disable_ssl(idevice_connection_t connection);
 ...
 */
IDEVICE_API idevice_error_t idevice_get_handle(idevice_t device, uint32_t *handle);
	
/**
 * Gets the unique id for the device.
 */
IDEVICE_API idevice_error_t idevice_get_udid(idevice_t device, char **udid);
