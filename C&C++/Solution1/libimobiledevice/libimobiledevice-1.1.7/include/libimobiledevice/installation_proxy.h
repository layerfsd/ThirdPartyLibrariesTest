...
#define INSTPROXY_API _declspec(dllexport)
 ...
 */
INSTPROXY_API instproxy_error_t instproxy_client_new(idevice_t device, lockdownd_service_descriptor_t service, instproxy_client_t *client);
 ...
 *     code otherwise.
 */
INSTPROXY_API instproxy_error_t instproxy_client_start_service(idevice_t device, instproxy_client_t * client, const char* label);
 ...
 */
INSTPROXY_API instproxy_error_t instproxy_client_free(instproxy_client_t client);
 ...
 *     an error occured.
 */
INSTPROXY_API instproxy_error_t instproxy_browse(instproxy_client_t client, plist_t client_options, plist_t *result);
 ...
 */
INSTPROXY_API instproxy_error_t instproxy_install(instproxy_client_t client, const char *pkg_path, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *     handled inside the specified callback function.
 */
INSTPROXY_API instproxy_error_t instproxy_upgrade(instproxy_client_t client, const char *pkg_path, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *     handled inside the specified callback function.
 */
INSTPROXY_API instproxy_error_t instproxy_uninstall(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *     an error occured.
 */
INSTPROXY_API instproxy_error_t instproxy_lookup_archives(instproxy_client_t client, plist_t client_options, plist_t *result);
 ...
 *     handled inside the specified callback function.
 */
INSTPROXY_API instproxy_error_t instproxy_archive(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *     handled inside the specified callback function.
 */
INSTPROXY_API instproxy_error_t instproxy_restore(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *     handled inside the specified callback function.
 */
INSTPROXY_API instproxy_error_t instproxy_remove_archive(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 */
INSTPROXY_API plist_t instproxy_client_options_new();
 ...
 */
INSTPROXY_API void instproxy_client_options_add(plist_t client_options, ...);
 ...
 *        is passed.
 */
INSTPROXY_API void instproxy_client_options_free(plist_t client_options);
 ...
 */
INSTPROXY_API instproxy_error_t instproxy_client_get_path_for_bundle_identifier(instproxy_client_t client, const char* bundle_id, char** path);
